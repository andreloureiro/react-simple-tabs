...
React.render(React.createElement(Tabs, {content:  content }), document.body);

},{"./components/Tabs.jsx":160,"react":157}],2:[function(require,module,exports){
...
var TabContent = React.createClass({displayName: "TabContent",
	...
	render : function () {		
		...
		return (
			React.createElement("div", {className:  this.props.activeContent ? 'content-show' : 'content-hide'}, 
				 this.props.content
			)
		)
	}
...
},{"./TabContent.jsx":158,"./TabItem.jsx":159,"react":157}]},{},[1]);
